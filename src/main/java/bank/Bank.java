...
public interface Bank {
     ...
     */
    double getAccountBalance(String account) throws AccountDoesNotExistException, TransactionAttributeException;
     ...
     */
    List<Transaction> getTransactions(String account)throws AccountDoesNotExistException, TransactionAttributeException;
    ...
    /**
     * Löscht einen Account und alle zugehörigen Daten
     * @param account Der zu löschende Account-Name
     * @throws AccountDoesNotExistException wenn Account nicht existiert
     * @throws IOException bei Problemen mit Dateisystem
     */
    void deleteAccount(String account)
            throws AccountDoesNotExistException, IOException;

    /**
     * Gibt alle Account-Namen zurück
     * @return Liste aller Account-Namen
     */
